...
<ul id="css3menu1" class="topmenu">
	...
	<li class="topmenu"><a href="cp/chatusers/payment.php" style="height:10px;line-height:10px;">Buy Tokens</a>	</li>
...
<?php if($model) {
		...
		echo '<li><a href="cp/chatmodels/index.php">My Account</a></li>
