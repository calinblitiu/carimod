...
class ControllerAuthentication
{
    ...
    public function login($username, $password) 
    {
        $stmt = $this->pdo->prepare('SELECT * 
                                FROM tbl_itemfinder_authentication 
    ...
    {
        $stmt = $this->pdo->prepare('INSERT INTO tbl_itemfinder_authentication( username, password, name, role_id ) 
    ...
    public function updateAccessUser($itm) 
    {
        ...
        $stmt = $this->pdo->prepare('UPDATE tbl_itemfinder_authentication 
                                        SET 
                                            username = :username,
                                            password = :password,
                                            name = :name
