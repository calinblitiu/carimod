    ...
    <script type="text/javascript">
        $(function(){
            ...
            var marker = new google.maps.Marker({
                    position: new google.maps.LatLng( <?php echo "$item->lat, $item->lon";?>, true ),
                    map: map,
                    title: 'Here!'
                });
                ...
                <div class="col-md-7">
                  ...
                  <form action="" method="POST">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Item Name" name="item_name" required value="<?php echo $item->item_name; ?>">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Item Price" name="item_currency" required value="<?php echo $item->item_currency; ?>" maxlength="3">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Item Price" name="item_price" required value="<?php echo $item->item_price; ?>">
                      </div>
                      ...
                      <div class="input-group" style="width:100%;" >
                        <select class="form-control" style="width:100%;" name="featured">
                          ...
                          <option <?php echo $item->featured == 1 ? 'selected' : ''; ?> value="1">Item Featured</option>
                          <option <?php echo $item->featured == 0 ? 'selected' : ''; ?> value="0">Item Not Featured</option>
                        </select>
                      </div>
                      ...
                      <div class="input-group" style="width:100%;" >
                        <select class="form-control" style="width:100%;" name="item_status">
                          <option <?php echo $item->item_status == 1 ? 'selected' : ''; ?> value="1">Sold Item</option>
                          <option <?php echo $item->item_status == 0 ? 'selected' : ''; ?> value="0">Not Sold Item</option>
                        </select>
                      </div>
                      ...
                      <div class="input-group" style="width:100%;" >
                        <select class="form-control" style="width:100%;" name="item_type">
                          <option <?php echo $item->item_type == 1 ? 'selected' : ''; ?> value="1">Used Item</option>
                          <option  <?php echo $item->item_type == 0 ? 'selected' : ''; ?> value="0">New item</option>
                        </select>
                      </div>
                          ...
                          <?php
                              if($categories != null) {
                                  foreach ($categories as $category)  {
                                        ...
                                        echo "<option $selected value='$category->category_id'>$category->category</option>";
                                  }
                              }
                          ?>
                              ...
                              if($users != null) {
                                  foreach ($users as $user)  {
                                        ...
                                        if($item->user_id == $user->user_id)
                                          $selected = 'selected';
                                        echo "<option $selected value='$user->user_id'>$user->user_id - $user->full_name</option>";
                                  }
                              }
                          ?>
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Click on the Map for Latitude" name="lat" onkeypress='validateLatLng(event)' id="latitude" required readonly value="<?php echo $item->lat; ?>">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Click on the Map for Longitude" name="lon" onkeypress='validateLatLng(event)' id="longitude" required readonly value="<?php echo $item->lon; ?>">
                      </div>

                      <br />
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <textarea type="text" class="form-control" placeholder="Description" rows="10" name="item_desc" id="details"><?php echo $item->item_desc; ?></textarea>
                      </div>
