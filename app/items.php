              ...
              <?php 
                  if($items != null) {
                    ...
                    foreach ($items as $item)  {
                          ...
                          $flagUrl = $extras->encryptQuery1(KEY_SALT, 'item_id', $item->item_id, 'item_flags_view.php');
                          ...
                          $flag = "";
                          if($item->is_flag == 1)
                            $flag = "<a class='btn btn-primary btn-xs' href='$flagUrl'><span class='glyphicon glyphicon-flag'></span></a>";
