<?php 
  ...
  $backUrl = $extras->encryptQuery1(KEY_SALT, 'item_id', $item_id, 'photo_item_view.php');
...
<?php 
  ...
  function uploadFile($controller, $item_id) {
      $extras = new Extras();
      $itm = new Photo();
      $itm->item_id = $item_id;
      $backUrl = $extras->encryptQuery1(KEY_SALT, 'item_id', $item_id, 'photo_item_view.php');
    ...
    <div class="container">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">Add Item Photo</h3>
        </div>
