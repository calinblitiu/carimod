<?php 
  ...
  if(!empty($_SERVER['QUERY_STRING'])) {
      ...
      $reviews = $controllerReview->getReviewsByUserId($user_id);
      $user = $controllerUser->getUserByUserId($user_id);

      if($review_delete != null) {
          $user_id = $review_delete[0];
          $review_id = $review_delete[1];
          $controllerReview->deleteReview($review_id, 1);

          $viewUrl = $extras->encryptQuery1(KEY_SALT, 'user_id', $user_id, 'user_reviews_view.php');
    ...
    <div class="container">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
          <h4 class="panel-title pull-left" style="padding-top: 7px;"><?php echo $user->full_name."'s"; ?> Review</h4>
          <div class="btn-group pull-right">
            <!-- <a href="car_insert.php" class="btn btn-default btn-sm">Add Car</a> -->
            <form method="POST" action="">
                  <a href="users.php" class="btn btn-default btn-sm"><span class='glyphicon glyphicon-arrow-left'></span></a>
            </form>
          </div>
        </div>
              ...
              <?php 
                  ...
                  if($reviews != null) {
                    ...
                    foreach ($reviews as $review)  {
                          ...
                          $extras = new Extras();
                          $deleteUrl = $extras->encryptQuery2(KEY_SALT, 'user_id', $user_id, 'review_id', $review->review_id, 'user_reviews_view.php');
