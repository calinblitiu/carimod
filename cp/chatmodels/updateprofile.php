...
&nbsp;</td>
		  ...
		  echo "<font color=#ffdd54>Phone*</font>";
            ...
            <tr>
              ...
              <td align="right" valign="top" class="form_definitions"><? if($tempAdress==""){ echo "<font color=#ffdd54>Address: *</font>";
          ...
          <table width="720" border="0" cellspacing="0" cellpadding="4">
            ...
            <tr>
              ...
              <td align="left" valign="top"><select name="PMethod" id="PMethod">
                ...
                <option value="Check"  <? if ($tempPMethod=="Check"){echo "selected";}?> >Check</option>
                <option value="Transfer"  <? if ($tempPMethod=="Transfer"){echo "selected";}?> >Transfer</option>
                <option value="Mon Cash"  <? if ($tempPMethod=="Mon Cash"){echo "selected";}?> >Mon Cash</option>
              </select></td>
              <td><span class="style1"></span></td>
            </tr>
            ...
            <tr>
              ...
              <td align="left" valign="top" class="form_definitions">Please enter payment info. PayPal Email, Phone etc:</td>


              <td align="left" valign="top"><textarea name="PInfo" cols="24" rows="5" id="Adress"><? echo $tempPInfo;?></textarea></td>
