...
?>
            ...
            <br />
            <span class="style3">Account Balance: $
...
{
echo '<div class="token_box"><h1>'.$row->name.'</h1><h2>'.$row->tokens.' Tokens</h2><h3>Price $'.$row->price.'</h3><div class="btn">
<a href="payment.php"><img src="../../images/buy-package-btn-lg.png" /></a></div></div>';
//<a href="ccbill.php?amt='.$row->price.'&usr='.$username.'"><img src="../../images/buy-package-btn-lg.png" /></a></div></div>';
}
?>
