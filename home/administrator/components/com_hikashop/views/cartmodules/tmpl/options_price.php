...
?>
<div class="hkc-xl-6 hkc-md-6 hikashop_module_subblock hikashop_module_edit_product" style="<?php echo ((!empty($this->element['small_cart']) && (int)$this->element['small_cart'] == 1) ? 'display:none;' : ''); ?>" data-part="mini_cart">
