...
class EmailViewEmail extends hikashopView
{
	...
	public function emailtemplate() {
		...
		$content = JRequest::getString('templatecontent');
		$filename = JPath::clean(HIKASHOP_MEDIA.'mail'.DS.'template'.DS.$file.'.html.php');
		if(!empty($file) && empty($content) && file_exists($filename))
