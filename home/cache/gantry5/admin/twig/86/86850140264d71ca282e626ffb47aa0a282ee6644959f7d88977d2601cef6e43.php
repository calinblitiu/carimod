...
class __TwigTemplate_54e1b7acd19b0ef929b22575765bc44d48c65772efd146cd6e02d25c4b68cad5 extends Twig_Template
{
    ...
    ";
        // line 5
        $context["label"] = (($this->getAttribute((isset($context["field"]) ? $context["field"] : null), "picker_label", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["field"]) ? $context["field"] : null), "picker_label", array()), $this->env->getExtension('Gantry\Component\Twig\TwigExtension')->transFilter("GANTRY5_PLATFORM_PICK_PARTICLE"))) : ($this->env->getExtension('Gantry\Component\Twig\TwigExtension')->transFilter("GANTRY5_PLATFORM_PICK_PARTICLE")));
        // line 6
        echo "    ";
        $context["alt_label"] = (($this->getAttribute((isset($context["field"]) ? $context["field"] : null), "picker_label_alt", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["field"]) ? $context["field"] : null), "picker_label_alt", array()), $this->env->getExtension('Gantry\Component\Twig\TwigExtension')->transFilter("GANTRY5_PLATFORM_EDIT_PARTICLE"))) : ($this->env->getExtension('Gantry\Component\Twig\TwigExtension')->transFilter("GANTRY5_PLATFORM_EDIT_PARTICLE")));
        // line 7
        ...
        echo twig_escape_filter($this->env, twig_jsonencode_filter(array("type" => "particle", "field" => twig_escape_filter($this->env, $this->env->getExtension('Gantry\Component\Twig\TwigExtension')->fieldNameFilter(((isset($context["scope"]) ? $context["scope"] : null) . (isset($context["name"]) ? $context["name"] : null)))))), "html_attr");
...
";
    ...
    {
        return new Twig_Source("", "@gantry-admin/forms/fields/gantry/particle.html.twig", "/home3/menmwen/public_html/home/administrator/components/com_gantry5/templates/forms/fields/gantry/particle.html.twig");
    }
}
