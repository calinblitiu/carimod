...
return [
    ...
    'filename' => '/home3/menmwen/public_html/home/templates/it_mighty/custom/config/_error/index.yaml',
    'modified' => 1486509906,
    'data' => [
        'name' => '_error',
        'timestamp' => 1469466232,
        'version' => 7,
        'preset' => [
        ...
        'particles' => [
            ...
            'messages' => [
                'system-messages-5400' => 'System Messages'
            ],
            'content' => [
                'system-content-9936' => 'Page Content'
            ],
            'totop' => [
                'totop-1989' => 'Totop'
            ],
            'mobile-menu' => [
                'mobile-menu-2539' => 'Mobile-menu'
            ]
        ],
        'inherit' => [
