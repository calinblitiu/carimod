...
<div align="center">
  ...
  <table width="1001" height="75" border="0" cellpadding="0" cellspacing="0" background="2A1D1D">
          ...
          <table width="778" border="0" cellspacing="3" cellpadding="0">
            ...
            <tr>
              ...
              <td width="875"><div align="center">
                ...
                <p>                    <?php echo '<table width="720" border="0" align="center" cellpadding="0" cellspacing="5" bgcolor="">';
...
$select="select * from chatmodels c where not exists(select id from blockedcountry b where  b.model=c.user  and b.cc='$cc') and c.status='online' order by rand() limit 50;";
  ...
  //echo '<td height=0 align="center" valign="top"><span class="modelbox_title"><a href="ladydetails.php?user='.$username .'">BIO</a></span></td>';
		       ...
		       echo '<span class="model_title_small">';
				...
				echo '<span class="model_message"><a href="liveshow.php?model='.$username .'">FREE CHAT</a>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
<a href="liveshow.php?model='.$username .'"><h style="color:#D1751B;">ONLINE</h></a></span><br>';
  ...
  <p>
    ...
    <div align="center">
      <p>
    	...
    	effectspeed: 100 }).removeClass("lazy");
