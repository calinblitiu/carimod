...
background:transparent linear-gradient(#D3D8E8 , #FFF ) repeat scroll 0% 0%;
-->
  </style>
      ...
      <td><div align="center">
        ...
        <div>
          <div>
            ...
            <p class="law">Carimod </p>
            <p class="law">1232 NW Ave.<br>
             Miami, FL            </p>
            <p class="law">Administrator - contact@carimod.com</p>
          </div>
          <p>. </p>
          </div>
        </div></td>
